...
import Remote_access from "./components/remote_access";
        ...
        <AuthProvider>
          <ConditionalLayout>
            <Routes>
              ...
              <Route path="/remote-access/_session_/:room_id" element={<Session />} />
...
const ConditionalLayout = ({ children }) => {
  ...
  const isSessionRoute = location.pathname.startsWith("/remote-access/_session_");
